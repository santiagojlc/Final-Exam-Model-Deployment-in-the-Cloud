...
import pandas as pd
import numpy as np
from streamlit_animate import animated_rerun
...
# Wrap the content in animated_rerun to add animations when navigation changes
with animated_rerun(animation="fade"):
    if navigation == "Home":
